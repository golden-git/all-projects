    ...
    var $sync3 = $(".history-carousel .content-carousel"),
        ...
        $sync3
            .owlCarousel({
                ...
                margin: 0,
                nav: true,
                navText: [ '<span class="icon flaticon-right-arrow"></span>', '<span class="icon flaticon-left-arrow"></span>' ],
                dots: false,
                autoplay: true,
        ...
        $sync4
            .owlCarousel({
                ...
                nav: true,
                rtl: true,
                navText: [ '<span class="icon flaticon-arrow-point-to-right"></span>', '<span class="icon flaticon-last-track-left-arrow"></span>' ],
                dots: false,
                center: false,
                autoplay: true,
                autoplayTimeout: 5000,
